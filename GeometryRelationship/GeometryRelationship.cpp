...
int main()
{
	...
	std::string geometry_config_file = "C:/Users/harvey/source/repos/GeometryRelationship/GeometryRelationship/data/geometry_config.csv";
	relation_inferencer.ConstructTempObjects(geometry_config_file);

	// test geometry inference structure
	std::string measure_file = "C:/Users/harvey/Downloads/0515_plane2plane/0515_plane2plane.csv";
